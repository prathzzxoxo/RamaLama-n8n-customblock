...
export declare type BinaryFileType = 'text' | 'image' | 'video';
...
declare namespace ExecuteFunctions {
    namespace StringReturning {
        type NodeParameter = 'binaryProperty' | 'resource' | 'operation';
    }
...
export declare type IExecuteFunctions = ExecuteFunctions.GetNodeParameterFn & {
...
export declare type LoadingDetails = {
    className: string;
    sourcePath: string;
};
export declare type CredentialLoadingDetails = LoadingDetails & {
    nodesToTestWith?: string[];
};
export declare type NodeLoadingDetails = LoadingDetails;
export declare type KnownNodesAndCredentials = {
...
declare type LoadedData<T> = Record<string, LoadedClass<T>>;
export declare type ICredentialTypeData = LoadedData<ICredentialType>;
export declare type INodeTypeData = LoadedData<INodeType | IVersionedNodeType>;
export declare type LoadedNodesAndCredentials = {
    nodes: INodeTypeData;
