...
class WorkflowDataProxy {
    ...
    nodeContextGetter(nodeName) {
        ...
        if (!((_a = that.runExecutionData) === null || _a === void 0 ? void 0 : _a.executionData) && that.connectionInputData.length > 1) {
            return {};
        }
        if (!((_b = that.runExecutionData) === null || _b === void 0 ? void 0 : _b.executionData)) {
    ...
    nodeGetter() {
        ...
        return new Proxy({}, {
            get(target, name, receiver) {
                ...
                if (nodeName !== that.activeNodeName &&
                    !((_b = (_a = that.runExecutionData) === null || _a === void 0 ? void 0 : _a.resultData.runData) === null || _b === void 0 ? void 0 : _b.hasOwnProperty(nodeName))) {
                    throw new ExpressionError_1.ExpressionError(`no data, execute "${nodeName}" node first`, {
                        runIndex: that.runIndex,
                        itemIndex: that.itemIndex,
                        failExecution: true,
